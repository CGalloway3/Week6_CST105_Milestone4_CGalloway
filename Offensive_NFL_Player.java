...
public class Offensive_NFL_Player extends NFL_Player {
    ...
    public Offensive_NFL_Player(String name, LocalDate dob, float height, float weight, String birthPlace, int playersNumber, 
            String positionAbbreviation, String collegeAttended, int yearsExperienceInNFL, int gamesPlayed, int attempts,
            int completions, int yards, String longest, int touchdowns, int turnovers, int firstDowns, int twentyYardsPlus, int fortyYardsPlus) {
